...
type OverviewModuleTabId = "home" | "leaderboard" | "availability";

interface OverviewModulePageProps {
  role: ConsoleRole;
  activeTab: OverviewModuleTabId;
  eyebrow?: ReactNode;
  title: ReactNode;
...
export async function OverviewModulePage({
  role,
  activeTab,
  eyebrow,
  title,
  ...
  return (
    <div data-slot="overview-module-page" className="space-y-6">
      <PageHero
        eyebrow={eyebrow ?? t("console.modules.overview")}
        title={title}
      ...
      <div
        data-slot="overview-module-tabs"
      ...
      <div data-slot="overview-module-content" className="space-y-6">
        {children}
      </div>
    </div>
  );
